            ...
            child:
                    ...
                    child: Container(
                      ...
                      child: TextFormField(
                        onChanged: (value) {
                          ...
                          context.read<Med_list>().sorting_med(value, context);
                        },
              ...
              search_med.isNotEmpty
                  ? Padding(
                      padding: const EdgeInsets.symmetric(horizontal: 15),
                      child: Container(
                        height: Provider.of<Med_list>(context, listen: false)
                                    .medlist
                                    .length ==
                                1
                            ? 45
                        ...
                        child: Provider.of<Med_list>(context, listen: false)
                                    .medlist
                                    .length ==
                                0
                            ? Center(
                                ...
                                itemBuilder: (context, ind) {
                                  return InkWell(
                                    onTap: () {
                                      ...
                                      var res = Provider.of<Med_list>(context,
                                              listen: false)
                                          .medlist[ind];
                                      context.read<Med>().Add_med_func(
                                          ...
                                          res["availqty"],
                                          res["price"]);
                                      context.read<Med>().change_totprice();
                                      price.text = Provider.of<Med>(context,
                                                      listen: false)
                                                  .tot_price
                                                  .toString() ==
                                              "0"
                                    ...
                                    child: Column(
                                      children: [
                                        ListTile(
                                          ...
                                          minTileHeight: 5,
                                          title: Text(Provider.of<Med_list>(
                                                  context,
                                                  listen: false)
                                              .medlist[ind]["medname"]),
                                        ),
